...
#year = data1.groupby('iyear')[['eventid']].count()
#fig =  px.bar(x= year.index, y = year.eventid, labels = {'y':'Number of attacks', 'x':'Year'}, title = "Attacks from 1970 to 2017")
#st.plotly_chart(fig)
...
# Create multiple selecter with  st.multiselect (note: multiselect vs. selectbox vs. radio)
...
# Severity of attacks
# st.subheader('Severity of the attacks based on number of casualties')
st.write(pdk.Deck(
...
# Clone data1 and add ncasualty col
